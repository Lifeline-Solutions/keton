...
const BioMedicineCourses = () => {
  return (
    <header
      className="bg-cover bg-top sm:h-[28rem] h-[32rem] flex flex-col justify-start items-start text-black bg-no-repeat relative"
      style={{
        backgroundImage: `url(/images/consulting-3.png)`,
      }}
    >
      <div className="absolute top-0 left-0 w-full sm:h-[28rem] h-[32rem] bg-primaryBlue opacity-80"></div>
