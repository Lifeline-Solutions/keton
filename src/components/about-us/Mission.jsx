      ...
      <div className="bg-gradient-to-l from-primaryBlue/40 to-transparent h-full flex flex-col justify-center items-center py-10 w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
          <div className="col-span-1 px-10 flex justify-center items-center">
            ...
            <img src="https://res.cloudinary.com/dlahz5ciz/image/upload/v1693327321/keton/Keton_Consulting50_dyn6xx.jpg" alt="mission" className="w-72 h-72 object-cover rounded-lg sm:absolute bottom-40 right-40" loading='lazy' />
            <img src="https://res.cloudinary.com/dlahz5ciz/image/upload/v1693327554/keton/Keton_Consulting18_s9jwbv.jpg" alt="vision" className="w-72 h-72 object-cover rounded-lg sm:mt-40 -mt-10 ml-10" loading='lazy' />
            </div>
          ...
          <div className="col-span-1 sm:px-4 px-16">
            ...
            <p className="text-left text-sm font-normal mt-4 leading-6 w-8/12">
              A leading bio-medicine consultancy firm that creates solutions through simplicity, innovation, freedom and excellence.
            </p>
