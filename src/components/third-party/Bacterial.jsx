        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
          <div className="flex flex-col gap-2 text-sm mt-4 w-3/4 leading-6 px-4">
            ...
            <p>
              ...
              microorganism. These microorganism preparations are intended to be
              used for quality control of culture media,
              ...
              CultiControl microorganisms are packaged in a resealable vial that
              contains five (5) lyophilized pellets of a single microorganism
              strain and a desiccant to prevent adverse accumulations of
              moisture.
            </p>
            <br />
            <p>
              ...
              applications, including growth promotion testing of culture media
              to be employed in sterility testing. These microorganism
              preparations are derived from the American Type Culture Collection
              (ATCC®).
            </p>
            <br />
            <p>
          ...
          <div className="col sm:col-span-1 flex flex-col">
            <div className="relative bg-primaryBlue">
              ...
              <div className="sm:absolute">
                <img
                  src="https://res.cloudinary.com/dlahz5ciz/image/upload/v1697898705/keton/Rectangle_227_3_oheq08.png"
                  alt="logo"
