      ...
      <div className="flex flex-col justify-center gap-4 p-6 bg-primaryBg">
        <>
          ...
          <div className="flex flex-col gap-2 text-sm mt-4 w-3/4 leading-6 px-4">
            ...
            <p>
              (For In Vitro Diagnostic Use Only) Dia-Cont I-II kit is intended
              for normal and abnormal quality control for the following
              haemostasis screening tests: prothrombin time (PT), activated
              partial thromboplastin time (APTT), fibrinogen and thrombin time
              (TT). It does not provide as control for accuracy!
            </p>
            <br />
            <h1 className="text-md font-bold text-black capitalize">
              Summary & background
            ...
            <p>
              ...
              lyophilisation, which distort their original biological nature.
              For this reason they serve to check the repeatability and
