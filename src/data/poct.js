  ...
  products: [
    {
      ...
      description: [
        ...
        'Results (QC system+QR Code Built-in battery with long work cycle (72 hours);',
        'Calibration capability to store more than 5,000 results;',
        'small dimensions: 225x152x105 mm;',
        "7' touch screen;",
        'user-friendly interface;',
        'low weight: 3 kg.',
        'Test method: dry immunofluorescent lmmunoassay',
        'Research material whole blood,plasma, serum, urine, nasopharyngeal swabs.',
        'Nowadays there are 92 tests that allow you to measure parameters of differentprofiles such as: vitamins, hormones, Infectious diseases, renal function markers,inflammatory markers, tumor markers, cardiac markers, etc.',
      ],
    },
    {
      id: 802,
